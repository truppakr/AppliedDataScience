...
cbind(us.cities$long, us.cities$lat)
points(us.cities$long, us.cities$lat, col= my.cols
       , pch =16
       , cex = rescale(us.cities$pop,c(.5,7)))

cbind(us.states.lat.lon$Latitude,us.states.lat.lon$Longitude)
points(us.states.lat.lon$Longitude,us.states.lat.lon$Latitude, col= my.cols
       , pch =16
       , cex = rescale(us.health.states.fb$percent_fair_or_poor_health,c(.5,7)))
